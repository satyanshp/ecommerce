...
const Cart = ({onDelete ,items}) => {
              ...
              <div className='itemss'>
                ...
                <div className='info-container'>
                    ...
                    <div className='info-btn'>
                      <div className='stw' onClick = {()=>onDelete(items.id)}><Button bradius='3px' text='SAVE TO WISHLIST' color='white'bcolor='green' fs='12px' fw='600' width='150px'/></div>
                      <div className='remove' onClick = {()=>onDelete(items.id)}><Button bradius='3px' text='REMOVE' color='white' bcolor='rgb(197, 0, 0)' fs='12px' fw='600' width='80px'/></div>
                    </div>
                </div>
  ...
  </div>:<div className='emtycart'>
    <div>
      <img style={{width:'200px'}} src="./img/emtycart.png" alt="" />
